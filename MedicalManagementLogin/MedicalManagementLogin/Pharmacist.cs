...
namespace MedicalManagementLogin
{
    public partial class Pharmacist : Form
    {
        ...
        private void Pharmacist_Load(object sender, EventArgs e)
        {
            ...
            uC_P_Addcustomer1.Visible=false;
            viewCustomer1.Visible=false;
            btnDashboard.PerformClick();
        }

        private void btnnAddMedicine_Click(object sender, EventArgs e)
        {
        ...
        private void btnMedicineValiditiy_Click(object sender, EventArgs e)
        {
        ...
        {
            uC_P_Addcustomer1.Visible = true;
            uC_P_Addcustomer1.BringToFront();
        }

        private void viewcust_Click(object sender, EventArgs e)
        {
            viewCustomer1.Visible = true;
